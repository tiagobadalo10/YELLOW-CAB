...
class ZoneServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
            '/zonepb.ZoneService/HealthCheck',
            request_serializer=zone__pb2.HealthCheckRequest.SerializeToString,
            response_deserializer=zone__pb2.HealthCheckResponse.FromString,
        )
...
def add_ZoneServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'HealthCheck': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=zone__pb2.HealthCheckRequest.FromString,
            response_serializer=zone__pb2.HealthCheckResponse.SerializeToString,
        ),
    }
...
class ZoneService(object):
    ...
    def HealthCheck(request,
                    ...
                    timeout=None,
                    metadata=None):
        return grpc.experimental.unary_unary(request, target, '/zonepb.ZoneService/HealthCheck',
                                             zone__pb2.HealthCheckRequest.SerializeToString,
                                             zone__pb2.HealthCheckResponse.FromString,
                                             options, channel_credentials,
                                             insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
